...
def parse_args():
    ...
    parser.add_argument("--task_type", type=str, choices=["cls", "reg", "multi_reg"], default="reg")
    parser.add_argument("--data_type", type=str, choices=["normal", "reduce", "none", "didb", "didb_reduce"], default="didb_reduce")
